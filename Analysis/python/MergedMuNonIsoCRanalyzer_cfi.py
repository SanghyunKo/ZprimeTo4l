...
mergedMuNonIsoCRanalyzer = cms.EDAnalyzer("MergedMuNonIsoCRanalyzer",
  isMC = cms.bool(True),
...
mergedMuNonIsoCRanalyzer20UL16APV = mergedMuNonIsoCRanalyzer.clone(
  METfilterList = cms.vstring(
    "Flag_goodVertices",
    "Flag_globalSuperTightHalo2016Filter",
    "Flag_HBHENoiseFilter",
...
mergedMuNonIsoCRanalyzer20UL17 = mergedMuNonIsoCRanalyzer.clone(
  METfilterList = cms.vstring(
    "Flag_goodVertices",
    "Flag_globalSuperTightHalo2016Filter",
    "Flag_HBHENoiseFilter",
...
mergedMuNonIsoCRanalyzer20UL18 = mergedMuNonIsoCRanalyzer.clone(
  METfilterList = cms.vstring(
    "Flag_goodVertices",
    "Flag_globalSuperTightHalo2016Filter",
    "Flag_HBHENoiseFilter",
