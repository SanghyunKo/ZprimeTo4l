...
resolvedEMuCRanalyzer = cms.EDAnalyzer("ResolvedEMuCRanalyzer",
  ...
  RMFFpath = cms.FileInPath("ZprimeTo4l/Analysis/data/RMFF_run2.root"),
  REFFpath = cms.FileInPath("ZprimeTo4l/Analysis/data/REFF_run2.root"),
  FFdr03path = cms.FileInPath("ZprimeTo4l/Analysis/data/REFFdr03_run2.root"),
  ptThresTrig = cms.double(52.),
  ptThres = cms.double(20.),
  ffSystCL95 = cms.double(0.0),
