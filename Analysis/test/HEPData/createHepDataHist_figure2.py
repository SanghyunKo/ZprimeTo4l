...
class HepDataTable:
    ...
    def createTable(self,treename):
        self.figure = "figure2_1" if treename=="limitTreeA" else "figure2_2"
...
table.createTable("limitTreeA")
submission.add_table(table.table)
table.createTable("limitTreeZ")
submission.add_table(table.table)

submission.create_files("figure2",remove_old=True)
